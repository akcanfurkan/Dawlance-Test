...
WebUI.click(findTestObject('Object Repository/Page_Breakfast  Beverages  Dawlance/h1_Breakfast  Beverages'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Breakfast  Beverages  Dawlance/h1_Breakfast  Beverages'), 
    'Breakfast & Beverages')

WebUI.click(findTestObject('Object Repository/Page_Breakfast  Beverages  Dawlance/a_Review'))

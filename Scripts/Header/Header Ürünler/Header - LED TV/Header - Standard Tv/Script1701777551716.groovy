...
WebUI.click(findTestObject('Object Repository/Page_LED TV  Dawlance/h2_Standard TV'))

WebUI.click(findTestObject('Object Repository/Page_Standard TV  Dawlance/h1_Standard TV'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Standard TV  Dawlance/h1_Standard TV'), 'Standard TV')

WebUI.click(findTestObject('Object Repository/Page_Standard TV  Dawlance/a_Review'))
